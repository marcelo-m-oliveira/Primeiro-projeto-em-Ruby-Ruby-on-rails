class MiningTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @mining_type.save
        format.html { redirect_to @mining_type, notice: t('notice.created_successfully_mining_type') }
  ...
  def update
    respond_to do |format|
      if @mining_type.update(mining_type_params)
        format.html { redirect_to @mining_type, notice: t('notice.updated_successfully_mining_type') }
  ...
  def destroy
    @mining_type.destroy
    respond_to do |format|
      format.html { redirect_to mining_types_url, notice: t('notice.destroyed_successfully_mining_type') }
